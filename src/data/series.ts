...
export const frontendSeries: Series = {
  ...
  episodes: [
    ...
    { num: 16, slug: 'part16', title: 'How Vue Files Become JavaScript',           progress: 70  },
    { num: 17, slug: 'part17', title: 'CSS — The Language of Style',              progress: 74  },
    { num: 18, slug: 'part18', title: 'Tailwind CSS',                              progress: 78  },
    { num: 19, slug: 'part19', title: 'ESLint & Stylelint',                        progress: 83  },
    { num: 20, slug: 'part20', title: 'Environment Variables & .env Files',        progress: 87  },
    { num: 21, slug: 'part21', title: 'Authentication & Route Guards',             progress: 91  },
    { num: 22, slug: 'part22', title: 'Production, CDN & Deployment',             progress: 96  },
    { num: 23, slug: 'part23', title: 'The Full Picture',                          progress: 100 },
  ],
};
